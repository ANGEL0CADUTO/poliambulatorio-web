...
export default function ProvaBikiniPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-background-light text-gray-900 overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] min-[1921px]:min-h-0 flex items-center justify-center pt-6 sm:pt-12 lg:pt-20 min-[1921px]:pt-16 pb-16 lg:pb-20 min-[1921px]:pb-24 overflow-hidden bg-background-light border-b border-gray-200/60">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            {/* Left Content Column */}
            <div className="lg:col-span-7 min-[1921px]:col-span-6 space-y-6 sm:space-y-8 order-2 lg:order-1">
              ...
              <h1 className="text-3xl sm:text-5xl lg:text-7xl min-[1921px]:text-8xl font-extrabold tracking-tight leading-[1.1] font-display text-gray-900">
              ...
              <p className="text-base sm:text-lg min-[1921px]:text-2xl text-gray-600 leading-relaxed font-medium">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
                <div className="flex items-center gap-3 p-3 rounded-2xl bg-white border border-gray-200/60 shadow-soft">
                  ...
                  <span className="text-sm lg:text-base min-[1921px]:text-lg font-bold text-gray-800">Protocollo Clinico</span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-2xl bg-white border border-gray-200/60 shadow-soft">
                  <Building className="w-5 h-5 text-primary-dark flex-shrink-0" />
                  <span className="text-sm lg:text-base min-[1921px]:text-lg font-bold text-gray-800">Palestra Medica Autorizzata</span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-2xl bg-white border border-gray-200/60 shadow-soft">
                  <UserCheck className="w-5 h-5 text-amber-600 flex-shrink-0" />
                  <span className="text-sm lg:text-base min-[1921px]:text-lg font-bold text-gray-800">Medici e Nutrizionisti</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <a
                  href="#contattaci"
                  className="inline-flex justify-center items-center gap-2 px-8 min-[1921px]:px-10 py-4 min-[1921px]:py-5 text-base min-[1921px]:text-lg font-bold rounded-full text-white bg-amber-500 hover:bg-amber-600 transition-all transform hover:scale-105 shadow-soft shadow-amber-500/20 duration-300 text-center"
                >
                ...
                <a
                  href="#percorso"
                  className="inline-flex justify-center items-center px-8 min-[1921px]:px-10 py-4 min-[1921px]:py-5 text-base min-[1921px]:text-lg font-bold rounded-full text-gray-700 border-2 border-primary/20 hover:border-primary/40 bg-white hover:bg-gray-50 transition-all text-center shadow-sm"
                >
                  Scopri il Percorso
                </a>
              </div>
            ...
            <div className="lg:col-span-5 min-[1921px]:col-span-6 hidden lg:block order-1 lg:order-2">
